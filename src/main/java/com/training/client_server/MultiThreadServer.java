package main.java.com.training.client_server;
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket server = new ServerSocket(3345);
            ...
            while (!server.isClosed()) {
                ...
                // проверяем поступившие команды из консоли сервера, если такие
                // были
                if (br.ready()) {
                    System.out.println("Main Server found any messages in channel, let's look at them.");

                    // если команда - quit, то инициализируем закрытие сервера и
                    // выход из цикла раздачи нитей моно-поточных серверов
                ...
                // если команд от сервера нет, то становимся в ожидание
                ...
                // моно-поточную нить = сервер - MonoThreadClientHandler и тот
